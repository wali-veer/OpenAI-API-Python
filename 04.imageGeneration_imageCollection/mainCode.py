...
from handler import downloadFile, generate_image, get_files

desired_size = (600, 400)

# Streamlit App
st.title(" Image Generation Gallery")  # Add a title
margin = '<div style="margin: 20px 5px;"></div>'

# User input
with st.form("user_form", clear_on_submit=True):
    user_input = st.text_input("Describe the image you want to generate")
...
if submit_button:
    with st.spinner("Generating image...",show_time=True):
        ...
        st.success("Image was successfully generated and saved to gallaery folder")
